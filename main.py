...
#we don't need this function for our implementation as data is loaded inside bag and boost function itself
...
def learn_bagged(tdepth, numbags, datapath):
    bagging_tree(tdepth,numbags,datapath)
...
def learn_boosted(tdepth, numtrees, datapath):
    boosting_tree(tdepth, numtrees, datapath)
